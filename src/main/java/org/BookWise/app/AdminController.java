...
import org.BookWise.app.DatabaseAccess.*;
...
public class AdminController {
    ...
    public void initialize() {
        ...
        columnsFromRecord(finesTable, Fine.class,
                Map.of("fineID", "Fine ID", "loanID", "Loan ID", "userID", "User ID",
                       "fineAmount", "Amount", "fineDate", "Date Issued", "paymentStatus", "Status"));
        
        finesTable.setItems(FXCollections.observableArrayList(DatabaseAccess.getFines()));
        System.out.println(finesTable.getItems());
    }
    ...
    public void delete(ActionEvent actionEvent) {
        ...
        switch (item) {
            ...
            case Fine fine -> DatabaseAccess.payFine(fine.fineID());
            default -> {}
        }
    }
